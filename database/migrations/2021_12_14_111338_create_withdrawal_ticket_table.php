...
class CreateWithdrawalTicketTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('withdrawal_ticket');
    }
}
